// Local persistence: best score + best combo + audio pref. Device-local.
const SCORE_KEY = "piss_best_score";
const COMBO_KEY = "piss_best_combo";
const MUTED_KEY = "piss_muted";
